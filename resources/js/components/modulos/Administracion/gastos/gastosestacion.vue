    ...
    <v-row>
      <v-col cols="12">
        <v-card :loading="loading" elevation="8">
          ...
          <v-card-title>Ingreso de Gastos </v-card-title>
                ...
                <v-row>
                  ...
                  <v-col cols="12" sm="6">
                    <v-select
                      ...
                      v-model="tarea.proveedor"
                      item-text="NOMBRESALL"
                      item-value="id"
                      persistent-hint
                      single-line
                      label="Proveedores"
                      @change="consultaRucProveedor()"
                    ></v-select>
                  </v-col>
                  <v-col cols="12" sm="6">
                  ...
                  <v-col cols="12" >
                    <v-text-field
                      label="Factura"
                      hint="Ingrese Factura"
                      v-model="tarea.factura"
...
export default {
  data() {
    return {
      ...
      Cabeceratareas: [
        ...
        { text: "Gasto", value: "tipo_gasto_des", width: "25%" },
       
        { text: "fecha_emision", value: "fecha_emision", width: "15%" },
        { text: "detalle", value: "detalle", width: "15%" },

        { text: "Razon Social", value: "razon_social", width: "20%" },
        { text: "factura", value: "factura", width: "15%" },
  ...
  methods: {
    ...
    grabarTarea() {
      ...
      if (this.tarea.tipo_gasto == "" || this.tarea.tipo_gasto == 0) {
        this.$swal("Copedesa!!!", "Seleccione el tipo gasto", "error");
        return;
      }
      ...
      if (this.tarea.ruc == "" || this.tarea.ruc == 0) {
        this.$swal("Copedesa!!!", "Ingrese el RUC", "error");
        return;
      }

      if (this.tarea.factura == "" || this.tarea.factura == 0) {
        this.$swal("Copedesa!!!", "Ingrese la factura", "error");
        return;
      }

      if (this.tarea.total == "" || this.tarea.total == 0) {
        this.$swal("Copedesa!!!", "Ingrese el total", "error");
        return;
      }
      ...
      let url =
        this.$store.getters.getRuta +
        "/modulos/admision/paciente/createGastosEstacion";
    ...
    consultasTareas() {
      let that = this;
      let url = "/modulos/admision/paciente/ConsultarGastosEstacion";
