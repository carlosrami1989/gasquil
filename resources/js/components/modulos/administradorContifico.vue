    ...
    <v-row no-gutters>
      ...
      <v-col cols="12" sm="6" class="pa-1">
        ...
        >
          ...
          <v-card-text>
            <canvas
              id="VentasPorductoMasVendidoCopemarket"
              width="200"
              height="200"
            ></canvas>
          </v-card-text>
      ...
      <v-col cols="12" sm="6" class="pa-1">
        ...
        >
          <v-system-bar color="indigo darken-2" dark class="white--text"
            >Mejor Vendedor</v-system-bar
          >
          <v-card-text>
            <canvas
              id="MejorVendedorCopemarket"
              width="200"
              height="200"
            ></canvas>
          </v-card-text>
...
export default {
  ...
  methods: {
    ...
    consultasFechaExpiracion() {
      ...
      let url =
        this.$store.getters.getRuta +
        "/modulos/admision/paciente/GetDocumentoCompra";
      ...
      axios
        ...
        .then((response) => {
          ...
          for (const iterator in ListaMejorVendedorEstaVentasLubri) {
            ...
            console.log(
              "entro undife",
              ListaMejorVendedorEstaVentasLubri[iterator]
            );
