<template>
  ...
  <v-app-bar app  >
    <!-- -->
      ...
      <v-toolbar-title> Sistema Gestión de Estaciones de Servicios</v-toolbar-title>
  ...
  props: {
    ...
    methods: {
      ...
      consultaPerfil() {
        ...
        {name:'Ingreso de Bitacora',icon: 'mdi-fuel', ruta:prefix+'/modulos/parametrizacion/tipodesechos',color:'pink'},
         {name:'Reportes de Estaciones',icon: 'mdi-clipboard-text-multiple', ruta:prefix+'/modulos/parametrizacion/clasificaciondesechos',color:'cyan darken-4'},
        ...
        //{name:'Rotary Astillero',icon: 'mdi-earth', ruta:'-',color:'orange darken-4'}
         ...
         {name:'Ingreso de Desechos',icon: 'mdi-fuel', ruta:prefix+'/modulos/administracion/ingreso',color:'green darken-4'},
